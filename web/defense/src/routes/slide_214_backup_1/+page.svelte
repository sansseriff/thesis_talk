  ...
  onMount(() => {
    ...
    keydownHandler = async function(event) {
      ...
      if (event.key === 'ArrowLeft' || event.key === 'PageUp') {
        ...
        navigate('/slide_213', '/slides_png/slide_213.png');
      }
      //Check if the pressed key is the right arrow key
        ...
        navigate('/slide_214_backup_2', '/slides_png/slide_214_backup_2.png');
      }
    };
...
<img src="/slides_png/slide_214_backup_1.png" alt="slide_214_backup_1" width="{$width}">
